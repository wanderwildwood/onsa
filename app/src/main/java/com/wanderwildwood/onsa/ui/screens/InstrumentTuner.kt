...
import com.wanderwildwood.onsa.notedetection.SortedAndDistinctInstrumentStrings
...
import com.wanderwildwood.onsa.ui.instruments.InstrumentButton
import com.wanderwildwood.onsa.ui.instruments.StringWithInfo
import com.wanderwildwood.onsa.ui.instruments.Strings
import com.wanderwildwood.onsa.ui.instruments.StringsScrollMode
import com.wanderwildwood.onsa.ui.instruments.StringsSidebarPosition
import com.wanderwildwood.onsa.ui.instruments.StringsState
import com.wanderwildwood.onsa.ui.misc.TunerScaffold
import com.wanderwildwood.onsa.ui.misc.rememberTunerAudioPermission
import com.wanderwildwood.onsa.ui.notes.NoteLockedButton
import com.wanderwildwood.onsa.ui.notes.NotePrintOptions
import com.wanderwildwood.onsa.ui.notes.NotePrintOptions2
import com.wanderwildwood.onsa.ui.notes.rememberMaxNoteSize
import com.wanderwildwood.onsa.ui.plot.GestureBasedViewPort
import com.wanderwildwood.onsa.ui.theme.TunerTheme
import com.wanderwildwood.onsa.ui.tuning.PitchHistory
...
interface InstrumentTunerData {
    ...
    val notePrintOptions: StateFlow<NotePrintOptions2>
...
fun InstrumentTuner(
    ...
    TunerScaffold(
        ...
        onStretchTuningClicked = onStretchTuningClicked,
...
class TestInstrumentTunerData : InstrumentTunerData {
    ...
    override val notePrintOptions: StateFlow<NotePrintOptions2>
            = MutableStateFlow(NotePrintOptions2())
