...
import com.wanderwildwood.onsa.temperaments.TemperamentTypeOld
import com.wanderwildwood.onsa.temperaments.predefinedTemperaments
import com.wanderwildwood.onsa.temperaments.resourceId
import com.wanderwildwood.onsa.ui.notes.NotationType
import com.wanderwildwood.onsa.ui.notes.NotePrintOptions
import com.wanderwildwood.onsa.ui.notes.NotePrintOptionsOld
...
class PreferenceResourcesOld @Inject constructor (
    ...
    val temperament: Temperament3?  get() {
        ...
        val t = predefinedTemperaments.firstOrNull {
            val name = it.name
            if (name is GetTextFromResId) {
                name.id == rid
            } else {
                false
            }
